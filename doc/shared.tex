...
%\usepackage[dvipsnames]{xcolor} % for definecolor
...
\definecolor{htmltagnamecolor}{RGB}{0, 128, 0}
\definecolor{htmltagkeycolor}{RGB}{125, 143, 40}
\definecolor{htmltagvaluecolor}{RGB}{186, 33, 33}

\newcommand{\hlthing}[1]{\textcolor{orange}{#1}}
\newcommand{\hlcomment}[1]{\textcolor{blue}{#1}}
\newcommand{\tagname}[1]{\textcolor{htmltagnamecolor}{#1}}
\newcommand{\tagkey}[1]{\textcolor{htmltagkeycolor}{#1}}
\newcommand{\tagvalue}[1]{\textcolor{htmltagvaluecolor}{#1}}
...
\author{
  \presentationauthor \hspace{1mm} \presentationauthoremail \\ Sune Lundø Sørensen \hspace{1mm} \href{mailto:slso@mmmi.sdu.dk}{slso@mmmi.sdu.dk}
}
