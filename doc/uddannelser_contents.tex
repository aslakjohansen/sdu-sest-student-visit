...
%      \coordinate (semorigo) at ([xshift=\xoffset] origo);
      ...
      % sem8
      \only<10->{
        \entry{analver}{8}{0}{1}{\textbf{\scalebox{0.9}{SW System Analysis}}\\\textbf{and Verification}}{5};
        ...
        \entry{semIIX}{8}{3}{4}{\textbf{Semesterprojekt:}\\\textbf{\scalebox{0.9}{Trustworthy Systems}}}{5};
