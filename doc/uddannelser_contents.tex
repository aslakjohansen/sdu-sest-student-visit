...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item Fylder 10 ECTS (på BSC/Diplom) eller 5 ECTS (på MSc).
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \descitem{40 ECTS} som mulighed. Dette vil "koste" et valgfag på 10 ECTS på 9. semester 
  \end{itemize}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \item Uddannelsen er rettet mod en specifik klasse af professioner:
      \begin{itemize}
        \item Industrielle kontrolsystemer
        \item Indlejrede systemer
        \item Cyber-Physical Systemer
      \end{itemize}
    \pause
    \item Uddannelsen er mere specialiseret: \\
      Hvor software ingeniør studiet give brede kompetencer, har man på software teknologi studiet valgt at skære de emner fra som ikke er relevante for indlejrede systemer mod at man kan gå mere i dybden.
  \end{itemize}
\end{frame}
