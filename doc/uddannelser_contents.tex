...
\begin{frame}
    \vspace{25mm}
    \begin{center}
        \Huge{Part 4:\\Software Teknologi}
    \end{center}
\end{frame}

\subsection{Studiet}
\begin{frame}[fragile]
  \frametitle{Software Teknologi \subpart{Studiet}}
  \vspace{1mm}
...
\subsection{Studiets Opbygning}
\begin{frame}[fragile]
  \frametitle{Software Teknologi \subpart{Studiets Opbygning}}
  \vspace{-2mm}
...
\begin{frame}[fragile]
  \frametitle{Software Teknologi \subpart{Ingeniørpraktik}}
  \vspace{3mm}
...
\begin{frame}[fragile]
  \frametitle{Software Teknologi \subpart{Afgangsprojekt}}
  \vspace{3mm}
