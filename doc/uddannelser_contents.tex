...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \descitem{Domæne:} Mekanik, Elektronik, Kinematik
    \item Programmering
  \end{itemize}
  ...
  \begin{itemize}
    \descitem{Ingeniør:} MSc (overbygning til tobotteknologi)
...
%      \coordinate (semorigo) at ([xshift=\xoffset] origo);
      ...
      \only<9->{
        ...
        \entryNormalMsc{model}{7}{1}{2}{\textbf{Systems}\\\textbf{Modeling}}{5};
        \entryNormalMsc{ubiq}{7}{2}{3}{\textbf{SE of Mobile and}\\\textbf{Ubiquitous Systems}}{5};
        \entryNormalMsc{bigdata}{7}{3}{4}{\textbf{Big Data and Data}\\\textbf{Science Tech.}}{5};
        \entryProjectMsc{semVII}{7}{4}{5}{\textbf{Semesterprojekt:}\\\textbf{Scalable Systems }}{5};
        \entryElectiveMsc{valgIV}{7}{5}{6}{\textbf{Valgfag}\\\textbf{}}{5};
        \node[align=left, minimum width=\labelpad, anchor=east] (labVII) at (sci.west) {\textbf{Semester 7}};
      }
      
      % sem8
      \only<10->{
        \entryNormalMsc{analver}{8}{0}{1}{\textbf{SW System Analysis}\\\textbf{and Verification}}{5};
        \entryNormalMsc{modeldriven}{8}{1}{2}{\textbf{Model-Driven}\\\textbf{SW Development}}{5};
        \entryNormalMsc{iot}{8}{2}{3}{\textbf{SW Technology of}\\\textbf{Internet of Things}}{5};
        \entryProjectMsc{semIIX}{8}{3}{4}{\textbf{Semesterprojekt:}\\\textbf{Trustworthy Systems}}{5};
        \entryElectiveMsc{valgV}{8}{4}{5}{\textbf{Valgfag}\\\textbf{}}{5};
        \entryElectiveMsc{valgVI}{8}{5}{6}{\textbf{Valgfag}\\\textbf{}}{5};
        \node[align=left, minimum width=\labelpad, anchor=east] (labIIX) at (analver.west) {\textbf{Semester 8}};
      }
      
      % sem9
      \only<11->{
        \entryNormalMsc{inno}{9}{0}{2}{\textbf{Innovative Software}\\\textbf{Solutions}}{10};
        \entryNormalMsc{adv}{9}{2}{3}{\textbf{Advanced SE}\\\textbf{Methodologies}}{5};
        \entryElectiveMsc{valgVII}{9}{3}{4}{\textbf{Valgfag}\\\textbf{}}{5};
        \entryElectiveMsc{valgIIX}{9}{4}{5}{\textbf{Valgfag}\\\textbf{}}{5};
        \entryElectiveMsc{valgIX}{9}{5}{6}{\textbf{Valgfag}\\\textbf{}}{5};
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item Uddannelsen er mere specialiseret: \\
      Hvor software ingeniør studiet give brede kompetencer, har man på software teknologi studiet valgt at skære de emner fra som ikke er relevante for indlejrede systemer mod at man kan gå mere i dybden med disse.
  \end{itemize}
\end{frame}
