      ...
      \begin{itemize}
        ...
        \item De første to semestre er næsten fælles for\\Software Engineering og Softwareteknologi$^\dagger$
          \begin{enumerate}
            ...
            \item Udvikling af Software Systemer / Udvikling af Innovative Software Systemer
          \end{enumerate}
...
%      \coordinate (semorigo) at ([xshift=\xoffset] origo);
      ...
      \only<7->{
        ...
        \entryNormal{ledelse}{6}{2}{3}{\textbf{Projektledelse}\\\textbf{og Forundersøgelse}}{7};
      ...
      % sem9
      \only<11->{
        \entryNormalMsc{inno}{9}{0}{2}{\textbf{Engineering of}\\\textbf{Innovative Software}}{10};
...
%      \coordinate (semorigo) at ([xshift=\xoffset] origo);
      ...
      % sem2
      \only<3->{
        \entryNormal{seo}{2}{0}{2}{\textbf{Software Engineering og}\\\textbf{Digitale Innovationer}}{10};
        \entryNormal{vop}{2}{2}{3}{\textbf{Videregående}\\\textbf{OOP}}{5};
        \entryNormal{md}{2}{3}{4}{\textbf{Data Management}\\}{5};
        \entryProject{semII}{2}{4}{6}{\textbf{Semesterprojekt:}\\\textbf{Udvikling af Innovative Softwaresystemer}}{10};
        \node[align=left, minimum width=\labelpad, anchor=east] (labII) at (seo.west) {\textbf{Semester 2}};
      }
      
      % sem3
      \only<4->{
        \entryNormal{indust}{3}{0}{1}{\textbf{Web}\\\textbf{Technologies}}{5};
        \entryNormal{statdata}{3}{1}{2}{\textbf{Anvendt Statistik}\\\textbf{og Dataanalyse}}{5};
        \entryNormal{webtech}{3}{2}{3}{\textbf{Algoritmer}\\\textbf{og Datastrukturer}}{5};
        \entryNormal{osd}{3}{3}{4}{\textbf{Operativsystemer}\\\textbf{og Dist. Systemer}}{5};
        \entryProject{semIII}{3}{4}{6}{\textbf{Semesterprojekt:}\\\textbf{Distribuerede Software Systemer}}{10};
        \node[align=left, minimum width=\labelpad, anchor=east] (labIII) at (indust.west) {\textbf{Semester 3}};
      }
      
      % sem4
      \only<5->{
        \entryNormal{reliable}{4}{0}{1}{\textbf{Frontend}\\\textbf{Testing}}{2};
        \entryNormal{swtech}{4}{1}{2}{\textbf{Frontend}\\\textbf{Software Design}}{10};
        ...
        \entryProject{semIV}{4}{4}{6}{\textbf{Semesterprojekt:}\\\textbf{Fleksible Frontend}}{10};
        \node[align=left, minimum width=\labelpad, anchor=east] (labIV) at (reliable.west) {\textbf{Semester 4}};
      }
      
      % sem5
      \only<6->{
        \entryNormal{algo}{5}{0}{1}{\textbf{Mobile}\\\textbf{Software Development}}{5};
        ...
        \entryNormal{exp}{5}{4}{6}{\textbf{Experts in}\\\textbf{Transformative Teams}}{10};
